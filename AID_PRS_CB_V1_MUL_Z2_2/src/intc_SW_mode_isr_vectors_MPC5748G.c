...
extern void uart1_recv_isr(void);
extern void uart1_send_isr(void);
...
(uint32_t) &pit2_isr, /* Vector # 228 Periodic Interrupt Timer (PIT2) PIT_1_TFLG2[TIF] */
...
(uint32_t) &uart1_recv_isr, /* Vector # 379 LinFlex1_0 LinFlex_1_RXI */
(uint32_t) &uart1_send_isr, /* Vector # 380 LinFlex1_1 LinFlex_1_TXI */
