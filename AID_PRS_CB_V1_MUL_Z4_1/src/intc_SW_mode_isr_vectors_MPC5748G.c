...
(uint32_t) &pit1_isr, /* Vector # 227 Periodic Interrupt Timer (PIT1) PIT_1_TFLG1[TIF] */
(uint32_t) &dummy, /* Vector # 228 Periodic Interrupt Timer (PIT2) PIT_1_TFLG2[TIF] */
(uint32_t) &pit3_isr, /* Vector # 229 Periodic Interrupt Timer (PIT3) PIT_1_TFLG3[TIF] */
...
(uint32_t) &can0_isr, /* Vector # 569 FlexCAN0_4 FlexCAN0_BUF_04_07 */
...
(uint32_t) &can1_isr, /* Vector # 581 FlexCAN1_3 FlexCAN1_BUF_04_07 */
...
(uint32_t) &can2_isr, /* Vector # 593 FlexCAN2_3 FlexCAN2_BUF_04_07 */
...
(uint32_t) &can3_isr, /* Vector # 605 FlexCAN3_3 FlexCAN3_BUF_04_07 */
...
(uint32_t) &can5_isr, /* Vector # 629 FlexCAN5_3 FlexCAN5_BUF_04_07 */
...
(uint32_t) &can7_isr, /* Vector # 653 FlexCAN7_3 FlexCAN7_BUF_04_07 */
