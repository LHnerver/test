...
void flash_save_cali_data(REGISTER_INFO reg_info,CALI_DATA cali_data,DEVICE_INFO dev_data)
{
	...
	*(unsigned int*)(CALI_ADDR + 64) = cali_data.ep_zero_valid ;
	*(unsigned int*)(CALI_ADDR + 68) = cali_data.br_zero_valid ;
...
void flash_get_cali_data(REGISTER_INFO* p_reg_info,CALI_DATA* p_cali_data,DEVICE_INFO* p_dev_data)
{
	...
	p_cali_data->ep_zero_valid   =  *(unsigned int*)(CALI_ADDR + 64);
    p_cali_data->br_zero_valid   =  *(unsigned int*)(CALI_ADDR + 68);
