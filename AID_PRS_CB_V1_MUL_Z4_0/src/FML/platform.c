...
//	INTC.PSR[617].B.PRIN = 4;     	/* FlexCAN_1 BUFF[4~7] IRQ priority = 4 */
	...
	//I2C_0
//	INTC.PSR[440].B.PRC_SELN0 = 1; 	/* PIT0 IRQ sent to Core 0 */
//	INTC.PSR[440].B.PRIN = 12;    	/* PIT0 IRQ priority = 12 (15 = highest) */

	//I2C_3
	INTC.PSR[446].B.PRC_SELN0 = 1; 	/* PIT0 IRQ sent to Core 0 */
	INTC.PSR[446].B.PRIN = 12;    	/* PIT0 IRQ priority = 12 (15 = highest) */
}
