...
extern void uart5_recv_isr(void);
extern void uart5_send_isr(void);
extern void uart8_recv_isr(void);
extern void uart8_send_isr(void);
extern void uart10_recv_isr(void);
extern void uart10_send_isr(void);

extern void uart7_recv_isr(void);
extern void i2c_3_callback(void);
...
(uint32_t) &pit0_isr, /* Vector # 226 Periodic Interrupt Timer (PIT0) PIT_1_TFLG0[TIF] */
...
(uint32_t) &uart5_recv_isr, /* Vector # 391 LinFlex5_0 LinFlex_5_RXI */
(uint32_t) &uart5_send_isr, /* Vector # 392 LinFlex5_1 LinFlex_5_TXI */
...
(uint32_t) &uart7_recv_isr, /* Vector # 397 LinFlex7_0 LinFlex_7_RXI */
(uint32_t) &dummy, /* Vector # 398 LinFlex7_1 LinFlex_7_TXI */
(uint32_t) &dummy, /* Vector # 399 LinFlex7_2 LinFlex_7_ERR */
(uint32_t) &uart8_recv_isr, /* Vector # 400 LinFlex8_0 LinFlex_8_RXI */
(uint32_t) &uart8_send_isr, /* Vector # 401 LinFlex8_1 LinFlex_8_TXI */
...
(uint32_t) &uart10_recv_isr, /* Vector # 406 LinFlex10_0 LinFlex_10_RXI */
(uint32_t) &uart10_send_isr, /* Vector # 407 LinFlex10_1 LinFlex_10_TXI */
...
(uint32_t) &i2c_3_callback, /* Vector # 446 I2C_3_0 I2C3_SR[IBAL] | I2C3_SR[TCF] | I2C3_SR[IAAS] */
